...
public class TransactionService {
    ...
    public String issueBook(int cardId, int bookId) throws Exception {
        ...
        // set general attributes of transaction which will be triggered whether the
        ...
        // if it comes here then book is present and availble ,card is present
        // ,activated and the limit is not crossed
